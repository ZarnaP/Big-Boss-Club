                      ...
                      <div class="card-body card-block">
                       ...
                       <!--   <div class="row form-group">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="number"  name="enrollmentNo" placeholder="Please enter your enrollment number" class="form-control"><small class="form-text text-muted">Please follow the date format</small></div>
                          </div>
                          <div class="row form-group">
