...
<body>
 ...
 <div class="col-lg-12">
 <form action="InsertFeeServlet" method="post">
                    <div class="card">
                      <div class="card-header">
                        <strong>Insert Fees</strong>
                      </div>
                      <div class="card-body card-block">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="number" id="enrollmentNo" name="enrollmentNo" placeholder="please enter the number" class="form-control"><small class="form-text text-muted">Please follow the date format</small></div>
                          </div>
                         
                       
                        
                         <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Membership Fee Amount</label></div>
                            <div class="col-12 col-md-3"><input type="number" id="membershipFee" name="membershipFeeAmount" placeholder="Please enter the amount" class="form-control"><small class="form-text text-muted"></small></div>
                          
                          
                          
                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">Membership Fee Date</label></div>
                            <div class="col-12 col-md-3"><input type="text" id="membershipFeeDate" name="membershipFeeDate" placeholder="Please enter the date" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
                          
                          
                         <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Test Fee Amount</label></div>
                            <div class="col-12 col-md-3"><input type="number" id="testFee" name="testFee" placeholder="Please enter the amount" class="form-control"><small class="form-text text-muted"></small></div>
                          
                          
                          
                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">Test Fee Date</label></div>
                            <div class="col-12 col-md-3"><input type="text" id="testFeeDate" name="testFeeDate" placeholder="Please enter the date" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
                                                    
                           
                         <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Product Fee</label></div>
                            <div class="col-12 col-md-3"><input type="number" id="productFee" name="productFee" placeholder="Please enter the amount" class="form-control"><small class="form-text text-muted"></small></div>
                          
                          
                          
                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">Product Fee Date</label></div>
                            <div class="col-12 col-md-3"><input type="text" id="productFeeAmount" name="productFeeDate" placeholder="Please enter the date" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
