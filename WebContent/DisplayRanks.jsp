    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <form action="InsertRankServlet" method="post">
         
            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Rank Number</label></div>
                            <div class="col-12 col-md-3"><input type="number" id="productFee" name="rankNumber" placeholder="" class="form-control"><small class="form-text text-muted"></small></div>
                          
                          
                          
                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">Belt Colour</label></div>
                            <div class="col-12 col-md-3"><input type="text" id="beltColour" name="beltColour" placeholder="Please enter the date" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
