...
<%@ page import="com.bbc_database.entities.*" %>
...
<body>
 ...
 <div class="col-lg-12">
 <form action="InsertStudentAttendanceServlet" method="post">
                    <div class="card">
                      <div class="card-header">
                       ...
                       <div class="card-body card-block">
                           ...
                           <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Class Level</label></div>
                            <div class="col-12 col-md-9"><input type="text"  name="classLevel" placeholder="Please enter your class level" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
                       
                         
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Enrollment No</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text" name="enrollmentNo" placeholder="Please enter the enrollemt no" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
    ...
    <!--    
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="parentEmail" name="parentEmail" placeholder="" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
                            -->
