...
<head>
    ...
    <meta name="description" content="BBC Admin">
    ...
    <link rel="stylesheet" href="assets/css/flag-icon.min.css">f
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="" alt="BBC"></a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.jsps">Advanced Form</a></li>
                        </ul>
                    </li>
