...
<body>
 ...
 <div class="col-lg-12">
 <form action="RankStudentServelt" method="post">
                    <div class="card">
                      <div class="card-header">
                        <strong>Rank Info</strong>
                      </div>
                      <div class="card-body card-block">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="number" id="enrollmentNo" name="enrollmentNo" placeholder="please enter the number" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>
